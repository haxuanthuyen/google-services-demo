...
public class GooglePlayAPI {
	...
	public GooglePlay.AndroidCheckinResponse checkin() throws Exception {
		...
		GooglePlay.AndroidCheckinResponse checkinResponse = postCheckin(Utils.generateAndroidCheckinRequest().toByteArray());
		...
		GooglePlay.AndroidCheckinRequest.Builder checkInbuilder = GooglePlay.AndroidCheckinRequest.newBuilder(Utils.generateAndroidCheckinRequest());

		GooglePlay.AndroidCheckinRequest build = checkInbuilder.setId(new BigInteger(this.getAndroidID(), 16).longValue())
	...
	public void login() throws Exception {
		...
		String[][] postParams = new String[][] { { "Email", this.getEmail() }, { "Passwd", this.password },
				...
				{ "device_country", "en" }, { "lang", "en" }, { "sdk_version", "16" }, { "client_sig", "38918a453d07199354f8b19af05ec6562ced5788" } };
		HttpEntity responseEntity = executePost(URL_LOGIN, postParams, null);
...
//				{ "device_country", "en" }, { "lang", "en" }, { "sdk_version", "16" }, { "client_sig", "38918a453d07199354f8b19af05ec6562ced5788" }, }, null);
	 ...
	 */
	public GooglePlay.SearchResponse search(String query) throws IOException {
	 ...
	 */
	public GooglePlay.SearchResponse search(String query, Integer offset, Integer numberOfResult) throws IOException {

		GooglePlay.ResponseWrapper responseWrapper = executeGETRequest(SEARCH_URL,
	 ...
	 */
	public GooglePlay.DetailsResponse details(String packageName) throws IOException {
		GooglePlay.ResponseWrapper responseWrapper = executeGETRequest(DETAILS_URL, new String[][] { { "doc", packageName }, });

		return responseWrapper.getPayload().getDetailsResponse();
	}

	/** Equivalent of details but bulky one! */
	public GooglePlay.BulkDetailsResponse bulkDetails(List<String> packageNames) throws IOException {

		GooglePlay.BulkDetailsRequest.Builder bulkDetailsRequestBuilder = GooglePlay.BulkDetailsRequest.newBuilder();
		bulkDetailsRequestBuilder.addAllDocid(packageNames);

		GooglePlay.ResponseWrapper responseWrapper = executePOSTRequest(BULKDETAILS_URL, bulkDetailsRequestBuilder.build().toByteArray(),
	...
	public GooglePlay.BrowseResponse browse() throws IOException {

		return browse(null, null);
	}

	public GooglePlay.BrowseResponse browse(String categoryId, String subCategoryId) throws IOException {

		GooglePlay.ResponseWrapper responseWrapper = executeGETRequest(BROWSE_URL, new String[][] { { "c", "3" }, { "cat", categoryId },
				{ "ctr", subCategoryId } });
	 ...
	 */
	public GooglePlay.ListResponse list(String categoryId) throws IOException {
	 ...
	 */
	public GooglePlay.ListResponse list(String categoryId, String subCategoryId, Integer offset, Integer numberOfResult) throws IOException {
		GooglePlay.ResponseWrapper responseWrapper = executeGETRequest(LIST_URL, new String[][] { { "c", "3" }, { "cat", categoryId },
	...
	public InputStream download(String packageName, int versionCode, int offerType) throws IOException {
		...
		GooglePlay.BuyResponse buyResponse = purchase(packageName, versionCode, offerType);

		GooglePlay.AndroidAppDeliveryData appDeliveryData = buyResponse.getPurchaseStatusResponse().getAppDeliveryData();
	 ...
	 */
	private GooglePlay.AndroidCheckinResponse postCheckin(byte[] request) throws IOException {
		...
		return GooglePlay.AndroidCheckinResponse.parseFrom(httpEntity.getContent());
	}
	 ...
	 */
	private GooglePlay.BuyResponse purchase(String packageName, int versionCode, int offerType) throws IOException {

		GooglePlay.ResponseWrapper responseWrapper = executePOSTRequest(PURCHASE_URL, new String[][] { { "ot", String.valueOf(offerType) },
	 ...
	 * respectively. These values are determined by Google Play Store.
	 */
	public GooglePlay.ReviewResponse reviews(String packageName, REVIEW_SORT sort, Integer offset, Integer numberOfResult)
			throws IOException {
		GooglePlay.ResponseWrapper responseWrapper = executeGETRequest(REVIEWS_URL,
	...
	public GooglePlay.UploadDeviceConfigResponse uploadDeviceConfig() throws Exception {
		...
		GooglePlay.ResponseWrapper responseWrapper = executePOSTRequest(UPLOADDEVICECONFIG_URL, request.toByteArray(),
				"application/x-protobuf");
	 ...
	 * respectively. These values are determined by Google Play Store.
	 */
	public GooglePlay.ListResponse recommendations(String packageName, RECOMMENDATION_TYPE type, Integer offset, Integer numberOfResult)
			throws IOException {
		GooglePlay.ResponseWrapper responseWrapper = executeGETRequest(RECOMMENDATIONS_URL,
	 ...
	 * */
	private GooglePlay.ResponseWrapper executeGETRequest(String path, String[][] datapost) throws IOException {
	 ...
	 * @see getHeaderParameters
	 * */
	private GooglePlay.ResponseWrapper executePOSTRequest(String path, String[][] datapost) throws IOException {
	 ...
	 */
	private GooglePlay.ResponseWrapper executePOSTRequest(String url, byte[] datapost, String contentType) throws IOException {
